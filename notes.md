...
| Register new user<br/>(t@jwt.com, pw: test)         | register.tsx       | [POST] /api/auth   | INSERT INTO user (name, email, password) VALUES (?, ?, ?) <br> INSERT INTO user (name, email, password) VALUES (?, ?, ?) <br> INSERT INTO auth (token, userId) VALUES (?, ?)|
...
| View franchise<br/>(as diner)                       | franchiseDashboad.tsx|/api/franchise/${user.id}| SELECT userId FROM auth WHERE token=?            |
